...
import com.mycompany.stringcalculator.NegativesNotAllowed;
...
public class StringCalculatorTest {
    ...
    @Test
    public void NegativeNotAlloved() {

        assertEquals("Negatives not allowed: -65,", 115, kalkulator.add("5,23,64,23,-65"));
    }
